...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
      // Always visible (removed group-hover opacity toggle), sized for easy tapping
      "absolute right-2 top-2 rounded-lg p-1.5 text-foreground/60 hover:text-foreground hover:bg-black/5 focus:outline-none focus:ring-2 focus:ring-ring transition-colors group-[.destructive]:text-red-200 group-[.destructive]:hover:text-white group-[.destructive]:hover:bg-red-700/30",
      className
    )}
    toast-close=""
