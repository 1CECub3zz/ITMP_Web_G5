      ...
      <div className="w-full max-w-md relative">
        ...
        <motion.div
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 border border-border rounded-xl py-2.5 text-sm font-medium hover:bg-muted transition-colors mb-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full border border-input bg-background rounded-xl px-4 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-brew-green" />
          ...
          <div className="text-center mt-5 space-y-2">
            <Link to="/forgot-password" className="text-sm text-muted-foreground hover:text-brew-green transition-colors">
              {t('auth.forgotPassword')}
            </Link>
            <p className="text-sm text-muted-foreground">
              {t('auth.noAccount')}{' '}
              <Link to="/register" className="text-brew-green font-semibold hover:underline">{t('auth.signUp')}</Link>
            </p>
          </div>
        </motion.div>
      </div>
